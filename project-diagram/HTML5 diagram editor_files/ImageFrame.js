...
function ImageFrame(url, x, y, scale, frameWidth, frameHeight){
    ...
    /**We will keep the initial point (as basic line) and another point just above it - similar to a vector.
     *
     *  * (x, y-20)
     *  |
     *  |
 ...
 * @param {String} url - the URL of the image. Pay attention to come from same basic URL as the application
