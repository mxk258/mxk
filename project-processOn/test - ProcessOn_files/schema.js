var Schema = {config: {markerSize: 14}, pageDefaults: {backgroundColor: "255,255,255", width: 1050, height: 1500, padding: 60, showGrid: true, gridSize: 15, orientation: "portrait"}, shapeDefaults: {id: "", name: "", title: "", category: "", group: "", groupName: null, locked: false, link: "", children: [], parent: "", resizeDir: ["tl", "tr", "br", "bl"], attribute: {container: false, visible: true, rotatable: true, linkable: true, collapsable: false, collapsed: false, markerOffset: 5}, dataAttributes: [], props: {x: 0, y: 0, w: 120, h: 80, zindex: 0, angle: 0}, shapeStyle: {alpha: 1}, lineStyle: {lineWidth: 2, lineColor: "50,50,50", lineStyle: "solid"}, fillStyle: {type: "solid", color: "255,255,255"}, path: [
    {actions: [
        {action: "move", x: "0", y: "0"},
        {action: "line", x: "w", y: "0"},
        {action: "line", x: "w", y: "h"},
...
], fontStyle: {fontFamily: "Arial", size: 13, color: "50,50,50", bold: false, italic: false, underline: false, textAlign: "center", vAlign: "middle", orientation: "vertical"}, textBlock: [
    ...
    {x: "0", y: "h/2"},
    {x: "w", y: "h/2"}
]}, linkerDefaults: {id: "", name: "linker", text: "", group: "", linkerType: "broken", points: [], locked: false, dataAttributes: [], props: {zindex: 0}, lineStyle: {lineWidth: 2, lineColor: "50,50,50", lineStyle: "solid", beginArrowStyle: "none", endArrowStyle: "solidArrow"}, fontStyle: {fontFamily: "Arial", size: 13, color: "50,50,50", bold: false, italic: false, underline: false, textAlign: "center"}}, categories: [], shapes: {}, markers: {}, themes: {}, addCategory: function (a) {
                            ...
                            if (c == "fontStyle") {
                                ...
                                if (c == "textBlock") {
                                    if (typeof b[c] != "undefined") {
                                        ...
                                        a[c] = [
                                            {position: this.extend({}, this.shapeDefaults.textBlock[0].position), text: ""}
                                        ]
                                    }
                                } else {
                                    if (typeof b[c] != "undefined") {
    ...
    shape.getTextBlock = function () {
        ...
        for (var i = 0; i < tbs.length; i++) {
            var tb = tbs[i];
            var p = tb.position;
            var newTb = {position: {x: eval(p.x), y: eval(p.y), w: eval(p.w), h: eval(p.h)}, text: tb.text, fontStyle: tb.fontStyle};
            result.push(newTb)
        }
        return result
    }
...
Schema.addMarker("expand", [
    {lineStyle: {lineWidth: 2, lineColor: "50,50,50", lineStyle: "solid"}, fillStyle: {type: "none"}, actions: [
...
Schema.addMarker("ad_hoc", [
    {lineStyle: {lineWidth: 3, lineColor: "50,50,50", lineStyle: "solid"}, fillStyle: {type: "none"}, actions: [
...
Schema.addMarker("parallel", [
    {lineStyle: {lineWidth: 4, lineColor: "50,50,50", lineStyle: "solid"}, fillStyle: {type: "none"}, actions: [
        {action: "move", x: 1, y: "0"},
        {action: "line", x: 1, y: "h"},
...
Schema.addShape({name: "standardText", title: "", category: "standard", attribute: {linkable: false}, props: {w: 160, h: 40}, anchors: [], textBlock: [
    {position: {x: 0, y: 0, w: "w", h: "h"}, text: "文本"}
], path: [
    {lineStyle: {lineWidth: 0}, fillStyle: {type: "none"}, actions: {ref: "rectangle"}}
]});
Schema.addShape({name: "standardImage", title: "", attribute: {linkable: false, visible: false}, category: "standard", props: {w: 100, h: 70}, textBlock: [], path: [
    {lineStyle: {lineWidth: 0}, actions: {ref: "rectangle"}}
]});
Schema.addShape({name: "standardRectangle", title: "", attribute: {visible: false}, category: "standard", props: {w: 100, h: 70}, textBlock: [
    {position: {x: 0, y: 0, w: "w", h: "h"}, text: ""}
], path: [
    {actions: {ref: "rectangle"}}
]});
var SchemaHelper = {constructPathFunBody: function (n) {
    var d = "return [";
...
var SchemaGroup = {groups: {}, addGroupShape: function (b, a) {
