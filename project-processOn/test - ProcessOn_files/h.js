(function () {
    var h = {}, mt = {}, c = {id: "2e25a5f27e6a91adc897f5760b9f753f", dm: ["processon.com"], js: "tongji.baidu.com/hm-web/js/", etrk: [], icon: '', ctrk: false, align: -1, nv: -1, vdur: 1800000, age: 31536000000, rec: 0, rp: [], trust: 0, vcard: 0, qiao: 0, lxb: 0, conv: 0, apps: ''};
    var p = !0, s = null, t = !1;
    mt.g = {};
    ...
    mt.localStorage.remove = function (a) {
        if (window.localStorage)window.localStorage.removeItem(a); else if (mt.localStorage.s())try {
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!l || !m) && e && k)u = p, r = +new Date; else if (l && m && (!e || !k))u = t, q += +new Date - r;
            l = e;
            m = k;
            x = setTimeout(b, 100)
        }
        ...
        function f(a) {
            var m = document, r = "";
            if (a in m)r = a; else for (var q = ["webkit", "ms", "moz", "o"], b = 0; b < q.length; b++) {
        ...
        var g = mt.event, n = h.w, l = p, e = p, m = p, k = p, v = +new Date, r = v, q = 0, u = p, w = f("visibilityState"), y = f("hidden"), x;
        b();
        (function () {
            ...
            "object" == typeof document.onfocusin ? (g.e(document, "focusin", d), g.e(document, "focusout", d)) : (g.e(window, "focus", d),
                g.e(window, "blur", d))
        })();
        h.t = {$: function () {
            return+new Date - v
    ...
    (function () {
        ...
        var f = mt.G, d = mt.lang, g = mt.m, n = h.I, l = h.w, e = {L: s, n: [], r: 0, M: t, init: function () {
            e.c = 0;
            e.L = {push: function () {
            ...
            if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
                ...
                var a = window._hmt;
                if (a && a.length)for (var b = 0, f = a.length; b < f; b++)d.d(a[b],
                    "Array") && "_trackEvent" !== a[b][0] && "_trackRTEvent" !== a[b][0] ? e.D(a[b]) : e.n.push(a[b]);
                window._hmt = e.L
            }
        }, X: function () {
            ...
            if (a = {webim: 1, tel: 2, map: 3, sms: 4, callback: 5, share: 6}[a[1]])e.c |= 32, h.b.a.et = 93, h.b.a.ep = a, h.b.j()
            ...
            if (d.d(b, "Object")) {
                ...
                if (900 >= l)f.call(this, b); else for (var l = Math.ceil(l / 900), r = "block|" + Math.round(Math.random() * n.q).toString(16) + "|" + l + "|", q = [], u = 0; u < l; u++)q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), f.call(this, r + q.join("|")),
                    q = []
            }
        }, _setUserId: function (a) {
            a = a[1];
            if (d.d(a, "String") || d.d(a, "Number")) {
                var b = h.b.A(), g = "hm-" + h.b.a.v;
    ...
    (function () {
        ...
        var b = mt.url, f = mt.G, d = mt.H, g = mt.lang, n = mt.cookie, l = mt.g, e = mt.localStorage, m = mt.sessionStorage, k = h.I, v = h.w;
        a.prototype = {C: function (a, b) {
            ...
            try {
                n.set(a, b, {domain: this.A(), path: this.J(), z: d}), d ? e.set(a, b, d) : m.set(a, b)
            } catch (f) {
            }
        }, ha: function (a) {
            try {
                n.set(a, "", {domain: this.A(), path: this.J(), z: -1}), m.remove(a), e.remove(a)
            } catch (b) {
            }
        }, na: function () {
            var a, b, d, e, f;
            k.l = this.getData("Hm_lpvt_" +
                c.id) || 0;
            ...
            if (0 === c.nv && this.p(document.location.href) &&
                ("" === document.referrer || this.p(document.referrer)))a = 0, b = 4;
            this.a.nv = a;
            this.a.st = b;
            this.a.cc = d;
            this.a.lt = e;
            ...
            try {
                this.oa(), 0 === this.a.nv ? this.la() : this.F(".*"), h.b = this, this.U(),
                    v.o("pv-b"), this.ka()
            } catch (a) {
                var b = [];
                b.push("si=" + c.id);
            ...
            var a = document.location.hash.substring(1), d = RegExp(c.id), e = -1 < document.referrer.indexOf(k.S) ? p : t, f = b.k(a, "jn"), g = /^heatlink$|^select$/.test(f);
            ...
            var b = m.get("Hm_unsent_" + c.id) || "", d = this.a.u ? "" : "&u=" + encodeURIComponent(document.location.href), b = encodeURIComponent(a.replace(/^https?:\/\//, "") + d) + (b ? "," + b : "");
