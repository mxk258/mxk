Schema.addCategory({name: "basic", text: "基础图形", dataAttributes: [
...
Schema.addShape({name: "text", title: "文本", category: "basic", attribute: {linkable: false}, props: {w: 160, h: 40}, anchors: [], textBlock: [
    {position: {x: 0, y: 0, w: "w", h: "h"}, text: "文本"}
], path: [
    ...
    c = c + 20;
    return[
        {lineStyle: {lineWidth: 2}, fillStyle: {type: "solid", color: "50, 50, 50"}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
...
Schema.addShape({name: "note", title: "备注", category: "basic", attribute: {linkable: false}, props: {w: 80, h: 100}, anchors: [], textBlock: [
    {position: {x: 10, y: 10, w: "w-20", h: "h-20"}}
], fillStyle: {color: "255, 255, 170"}, lineStyle: {lineWidth: 0}, path: [
    {actions: [
        {action: "move", x: "0", y: "0"},
...
Schema.addShape({name: "image", title: "Image", attribute: {linkable: false, visible: false}, category: "basic", textBlock: [], props: {w: 98, h: 72}, path: [
    {actions: {ref: "rectangle"}}
]});
Schema.addShape({name: "round", title: "圆形", category: "basic", props: {w: 70, h: 70}, path: [
    {actions: {ref: "round"}}
]});
Schema.addShape({name: "rectangle", title: "矩形", category: "basic", props: {w: 100, h: 70}, path: [
    {actions: {ref: "rectangle"}}
], anchors: [
    {x: "w*0.25", y: "0"},
    {x: "w*0.5", y: "0"},
...
Schema.addShape({name: "roundRectangle", title: "圆角矩形", category: "basic", props: {w: 100, h: 70}, path: [
    {actions: {ref: "roundRectangle"}}
]});
Schema.addShape({name: "triangle", title: "三角形", category: "basic", props: {w: 80, h: 70}, textBlock: [
...
Schema.addShape({name: "polygon", title: "五边形", category: "basic", props: {w: 74, h: 70}, textBlock: [
...
Schema.addShape({name: "hexagon", title: "六边形", category: "basic", props: {w: 84, h: 70}, path: [
    {actions: [
...
Schema.addShape({name: "octagon", title: "八边形", category: "basic", props: {w: 70, h: 70}, textBlock: [
    {position: {x: "10", y: "10", w: "w-20", h: "h-20"}}
], path: [
    {actions: [
...
Schema.addShape({name: "pentagon", title: "五角星", category: "basic", props: {w: 70, h: 70}, textBlock: [
...
Schema.addShape({name: "cross", title: "十字形", category: "basic", props: {w: 70, h: 70}, textBlock: [
    {position: {x: "0", y: "h*0.5-Math.min(w,h)/8", w: "w", h: "Math.min(w,h)*2/8"}}
], path: [
    {actions: [
...
Schema.addShape({name: "cloud", title: "云", category: "basic", props: {w: 90, h: 70}, textBlock: [
    {position: {x: 10, y: 10, w: "w-20", h: "h-20"}}
], anchors: [
    {x: "0", y: "h*0.5"},
    {x: "w*0.19", y: "h*0.9"},
...
Schema.addShape({name: "braces", title: "大括号", category: "basic", attribute: {linkable: false}, props: {w: 200, h: 140}, fillStyle: {type: "none"}, anchors: [
    {x: "w", y: "h*0.5"},
    {x: "0", y: "h*0.5"}
], path: [
    {fillStyle: {type: "none"}, actions: [
...
Schema.addShape({name: "parentheses", title: "中括号", category: "basic", attribute: {linkable: false}, props: {w: 200, h: 140}, fillStyle: {type: "none"}, anchors: [
    {x: "w", y: "h*0.5"},
    {x: "0", y: "h*0.5"}
], path: [
    {actions: [
...
Schema.addShape({name: "rightBrace", title: "备注", category: "basic", attribute: {linkable: false}, props: {w: 100, h: 140}, fontStyle: {textAlign: "left"}, fillStyle: {type: "none"}, textBlock: [
    {position: {x: "27", y: "0", w: "w-27", h: "h"}}
], anchors: [], path: [
    {actions: [
        {action: "move", x: "0", y: "h"},
    ...
    return[
        {actions: [
            ...
            {action: "quadraticCurve", x1: a + Math.min(b * 0.1, 9), y1: c, x: a + Math.min(b * 0.1, 9), y: c - Math.min(c * 0.1, 9)},
            ...
            {action: "quadraticCurve", x1: a + Math.min(b * 0.1, 9), y1: c * 0.5, x: a + Math.min(b * 0.1, 9), y: c * 0.5 - Math.min(c * 0.1, 9)},
            {action: "line", x: a + Math.min(b * 0.1, 9), y: Math.min(c * 0.1, 9)},
            {action: "quadraticCurve", x1: a + Math.min(b * 0.1, 9), y1: 0, x: a + 0, y: 0}
        ]}
    ]
}});
Schema.addShape({name: "leftBrace", title: "备注", category: "basic", attribute: {linkable: false}, props: {w: 100, h: 140}, fontStyle: {textAlign: "right"}, fillStyle: {type: "none"}, textBlock: [
    {position: {x: "0", y: "0", w: "w-27", h: "h"}}
], anchors: [], path: [
    {actions: [
        {action: "move", x: "w", y: "0"},
    ...
    return[
        {actions: [
            ...
            {action: "quadraticCurve", x1: b - Math.min(b * 0.1, 9) - a, y1: 0, x: b - Math.min(b * 0.1, 9) - a, y: Math.min(c * 0.1, 9)},
            ...
            {action: "quadraticCurve", x1: b - Math.min(b * 0.1, 9) - a, y1: c * 0.5, x: b - Math.min(b * 0.1, 9) - a, y: c * 0.5 + Math.min(c * 0.1, 9)},
            {action: "line", x: b - Math.min(b * 0.1, 9) - a, y: c - Math.min(c * 0.1, 9)},
            {action: "quadraticCurve", x1: b - Math.min(b * 0.1, 9) - a, y1: c, x: b - a, y: c}
        ]}
    ]
}});
Schema.addShape({name: "apqc", title: "APQC", category: "basic", props: {w: 200, h: 150}, path: [
    {actions: [
...
Schema.addShape({name: "teardrop", title: "水滴", category: "basic", props: {w: 70, h: 70}, path: [
    {actions: [
        {action: "move", x: "w", y: "0"},
...
Schema.addShape({name: "singleLeftArrow", title: "左箭头", category: "basic", props: {w: 90, h: 60}, anchors: [
    {x: "w", y: "h*0.5"},
    {x: "0", y: "h*0.5"}
], textBlock: [
    {position: {x: "0", y: "h*0.33", w: "w", h: "h*0.34"}}
], path: [
    {actions: [
...
Schema.addShape({name: "singleRightArrow", title: "右箭头", category: "basic", props: {w: 90, h: 60}, anchors: [
    {x: "w", y: "h*0.5"},
    {x: "0", y: "h*0.5"}
], textBlock: [
    {position: {x: "0", y: "h*0.33", w: "w", h: "h*0.34"}}
...
Schema.addShape({name: "doubleHorizontalArrow", title: "左右箭头", category: "basic", props: {w: 90, h: 60}, anchors: [
    {x: "w", y: "h*0.5"},
    {x: "0", y: "h*0.5"}
], textBlock: [
    {position: {x: "0", y: "h*0.33", w: "w", h: "h*0.34"}}
...
Schema.addShape({name: "singleUpArrow", title: "上箭头", category: "basic", props: {w: 60, h: 90}, anchors: [
    {x: "w*0.5", y: "0"},
    {x: "w*0.5", y: "h"}
], textBlock: [
...
Schema.addShape({name: "singleDownArrow", title: "下箭头", category: "basic", props: {w: 60, h: 90}, anchors: [
    {x: "w*0.5", y: "0"},
    {x: "w*0.5", y: "h"}
], textBlock: [
...
Schema.addShape({name: "doubleVerticalArrow", title: "上下箭头", category: "basic", props: {w: 60, h: 90}, anchors: [
    {x: "w*0.5", y: "0"},
    {x: "w*0.5", y: "h"}
], textBlock: [
...
Schema.addShape({name: "backArrow", title: "左返回箭头", category: "basic", props: {w: 70, h: 70}, anchors: [
    {x: "w-Math.min(w*0.12,20)", y: "h*0.5"},
    {x: "0", y: "h*0.5"}
], textBlock: [
    {position: {x: "0", y: "0", w: "w-10", h: "h"}}
], path: [
    {actions: [
...
Schema.addShape({name: "rightBackArrow", title: "右返回箭头", category: "basic", props: {w: 70, h: 70}, anchors: [
    {x: "Math.min(w*0.12,20)", y: "h*0.5"},
    {x: "w", y: "h*0.5"}
], textBlock: [
    {position: {x: "10", y: "0", w: "w-10", h: "h"}}
], path: [
    {actions: [
...
Schema.addShape({name: "corner", title: "拐角", category: "basic", props: {w: 70, h: 70}, anchors: [
    {x: "w*0.5", y: "0"},
    {x: "w*0.5", y: "0"},
    {x: "0", y: "h*0.5"},
    {x: "0", y: "h*0.5"}
