...
Schema.addShape({name: "uiHeading", title: "标题", category: "ui", attribute: {linkable: false}, props: {w: 120, h: 30}, anchors: [], fillStyle: {type: "none"}, fontStyle: {size: 26}, textBlock: [
    ...
    c += 2;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/heading.png", imageW: 30, imageH: 9, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiLabel", title: "标签", category: "ui", attribute: {linkable: false}, props: {w: 80, h: 25}, anchors: [], fillStyle: {type: "none"}, fontStyle: {size: 14}, textBlock: [
    ...
    c += 4;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/label.png", imageW: 26, imageH: 9, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiParagraph", title: "文字段落", category: "ui", attribute: {linkable: false}, props: {w: 240, h: 100}, anchors: [], fillStyle: {type: "none"}, fontStyle: {textAlign: "left", vAlign: "top", size: 14}, textBlock: [
    ...
    c += 8;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/paragraph.png", imageW: 26, imageH: 26, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiLink", title: "链接", category: "ui", attribute: {linkable: false}, props: {w: 80, h: 25}, anchors: [], fillStyle: {type: "none"}, fontStyle: {size: 14, underline: true, color: "65,131,196"}, textBlock: [
    {position: {x: 0, y: 0, w: "w", h: "h"}, text: "链接"}
], path: [
    {lineStyle: {lineWidth: 0}, actions: {ref: "rectangle"}}
], drawIcon: function (b, c) {
    var a = -4;
    ...
    c += 8;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/link.png", imageW: 26, imageH: 12, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiNote", title: "注释", category: "ui", attribute: {linkable: false}, props: {w: 80, h: 100}, anchors: [], textBlock: [
    {position: {x: 10, y: 10, w: "w-20", h: "h-20"}}
], fillStyle: {color: "255, 255, 170"}, lineStyle: {lineWidth: 0}, fontStyle: {size: 14}, path: [
    {actions: [
        {action: "move", x: "0", y: "0"},
    ...
    {fillStyle: {type: "solid", color: "r-50,g-50,b-50"}, actions: [
    ...
    return[
        ...
        {lineStyle: {lineWidth: 0}, fillStyle: {type: "solid", color: "205, 205, 120"}, actions: [
...
Schema.addShape({name: "uiBox", title: "盒容器", category: "ui", attribute: {linkable: false}, props: {w: 240, h: 80}, lineStyle: {lineWidth: 2, lineColor: "138,138,138"}, fillStyle: {type: "solid", color: "235,235,235"}, anchors: [], path: [
...
Schema.addShape({name: "uiBrowser", title: "浏览器", category: "ui", attribute: {linkable: false}, props: {w: 800, h: 500}, lineStyle: {lineWidth: 2, lineColor: "218,218,218"}, anchors: [], textBlock: [
    {position: {x: 60, y: 5, w: "w-70", h: "20"}, text: "http://www.processon.com", fontStyle: {textAlign: "left"}}
], path: [
    {actions: {ref: "roundRectangle"}},
    {fillStyle: {color: "r-37,g-37,b-37"}, actions: [
    ...
    c += 8;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/browser.png", imageW: 30, imageH: 24, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiDialog", title: "对话框", category: "ui", attribute: {linkable: false}, props: {w: 300, h: 160}, lineStyle: {lineWidth: 2, lineColor: "136,136,136"}, fontStyle: {textAlign: "left", size: 14}, anchors: [], textBlock: [
    {position: {x: 10, y: 5, w: "w-40", h: 25}, text: "标题", fontStyle: {vAlign: "middle"}},
    {position: {x: 10, y: 45, w: "w-20", h: "h-55"}, text: "内容..."}
], path: [
    {actions: {ref: "rectangle"}},
    {fillStyle: {color: "r-20,g-20,b-20"}, actions: [
        {action: "move", x: 0, y: 0},
        {action: "line", x: "w", y: 0},
    ...
    {fillStyle: {type: "image", fileId: "/images/designer/ui/close.png", imageX: "w-25", imageY: 8, imageW: 20, imageH: 20, display: "static"}, lineStyle: {lineWidth: 0}, actions: {ref: "rectangle"}}
], drawIcon: function (b, c) {
    var a = -4;
    b += 4;
    var d = -10;
    c += 8;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/dialog.png", imageW: 30, imageH: 30, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiTab", title: "Tab 标签页", category: "ui", attribute: {linkable: false}, props: {w: 360, h: 40}, lineStyle: {lineWidth: 2, lineColor: "136,136,136"}, fontStyle: {size: 14}, anchors: [], textBlock: [
    ...
    c += 8;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/tab.png", imageW: 30, imageH: 16, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiGrid", title: "Grid 数据网格", category: "ui", attribute: {linkable: false}, props: {w: 360, h: 150}, lineStyle: {lineWidth: 2, lineColor: "138,138,138"}, fontStyle: {size: 14}, anchors: [], textBlock: [
    ...
    {lineStyle: {lineWidth: 0}, actions: {ref: "rectangle"}},
    {fillStyle: {color: "r-37,g-37,b-37"}, lineStyle: {lineWidth: 0}, actions: [
        {action: "move", x: 0, y: 0},
        {action: "line", x: "w", y: 0},
    ...
    {fillStyle: {type: "none"}, lineStyle: {lineWidth: 1}, actions: [
...
Schema.addShape({name: "uiTooltip", title: "提示", category: "ui", attribute: {linkable: false}, props: {w: 140, h: 60}, lineStyle: {lineWidth: 2, lineColor: "138,138,138"}, anchors: [], path: [
    {actions: [
        {action: "move", x: "0", y: "8"},
...
Schema.addShape({name: "uiVideo", title: "视频", category: "ui", attribute: {linkable: false}, props: {w: 320, h: 240}, anchors: [], lineStyle: {lineColor: "138,138,138"}, textBlock: [], path: [
    {actions: {ref: "rectangle"}},
    {fillStyle: {type: "solid", color: "80,80,80"}, lineStyle: {lineWidth: 0}, actions: [
    ...
    {fillStyle: {type: "none"}, lineStyle: {lineWidth: 5, lineColor: "80,80,80"}, actions: [
        {action: "move", x: "30", y: "h-12.5"},
        {action: "line", x: "w-35", y: "h-12.5"},
    ]},
    {fillStyle: {type: "solid", color: "255,255,255"}, lineStyle: {lineWidth: 1, lineColor: "80,80,80", lineStyle: "solid"}, actions: [
    ...
    {fillStyle: {type: "solid", color: "80,80,80"}, lineStyle: {lineWidth: 4, lineColor: "80,80,80"}, actions: [
    ...
    c += 8;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/video.png", imageW: 30, imageH: 26, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiVScroll", title: "垂直滚动条", category: "ui", attribute: {linkable: false}, props: {w: 20, h: 160}, lineStyle: {lineWidth: 1, lineColor: "184,184,184"}, anchors: [], textBlock: [], resizeDir: ["t", "b"], path: [
    {lineStyle: {lineWidth: 0}, actions: {ref: "rectangle"}},
    {lineStyle: {lineWidth: 0}, fillStyle: {type: "solid", color: "229,229,229"}, actions: [
        {action: "move", x: 0, y: 0},
        {action: "line", x: "w", y: 0},
        {action: "line", x: "w", y: "w"},
        {action: "line", x: 0, y: "w"},
    ...
    {lineStyle: {lineWidth: 1}, fillStyle: {type: "none"}, actions: [
        {action: "move", x: 0, y: "w-0.5"},
        {action: "line", x: "w", y: "w-0.5"},
    ]},
    {lineStyle: {lineWidth: 0}, fillStyle: {type: "solid", color: "170,170,170"}, actions: [
    ...
    c += 8;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/scrollbar_v.png", imageW: 10, imageH: 30, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiHScroll", title: "水平滚动条", category: "ui", attribute: {linkable: false}, props: {w: 160, h: 20}, lineStyle: {lineWidth: 1, lineColor: "184,184,184"}, anchors: [], textBlock: [], resizeDir: ["l", "r"], path: [
    {lineStyle: {lineWidth: 0}, actions: {ref: "rectangle"}},
    {lineStyle: {lineWidth: 0}, fillStyle: {type: "solid", color: "229,229,229"}, actions: [
        {action: "move", x: 0, y: 0},
        {action: "line", x: "h", y: 0},
    ...
    c += 8;
    return[
        {fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/scrollbar_h.png", imageW: 30, imageH: 10, display: "original"}, lineStyle: {lineWidth: 0}, actions: [
            {action: "move", x: a, y: d},
            {action: "line", x: b, y: d},
            {action: "line", x: b, y: c},
            {action: "line", x: a, y: c},
...
Schema.addShape({name: "uiVLine", title: "垂直线", category: "ui", attribute: {linkable: false}, props: {w: 21, h: 240}, lineStyle: {lineWidth: 1, lineColor: "136,136,136"}, anchors: [], resizeDir: ["t", "b"], textBlock: [], path: [
    {fillStyle: {type: "none"}, actions: [
...
Schema.addShape({name: "uiHLine", title: "水平线", category: "ui", attribute: {linkable: false}, props: {w: 240, h: 21}, lineStyle: {lineWidth: 1, lineColor: "136,136,136"}, anchors: [], resizeDir: ["l", "r"], textBlock: [], path: [
    {fillStyle: {type: "none"}, actions: [
...
Schema.addShape({name: "uiLineChart", title: "折线图", category: "ui", attribute: {linkable: false}, props: {w: 240, h: 160}, lineStyle: {lineWidth: 2, lineColor: "136,136,136"}, anchors: [], fontStyle: {size: 14}, textBlock: [
    ...
    {fillStyle: {type: "none"}, lineStyle: {lineColor: "50,50,50"}, actions: [
        {action: "move", x: 0, y: "h"},
    ...
    return[
        ...
        {fillStyle: {type: "none"}, lineStyle: {lineColor: "50,50,50", lineWidth: 1}, actions: [
            {action: "move", x: 0, y: b},
...
Schema.addShape({name: "uiPieChart", title: "饼图", category: "ui", attribute: {linkable: false}, props: {w: 160, h: 160}, lineStyle: {lineWidth: 2, lineColor: "136,136,136"}, anchors: [], fontStyle: {size: 14}, textBlock: [
    ...
    {fillStyle: {type: "none"}, lineStyle: {lineWidth: 0}, actions: {ref: "round"}}
], drawIcon: function (a, b) {
    return[
        {lineStyle: {lineWidth: 1}, actions: [
            {action: "move", x: 0, y: b / 2},
            {action: "curve", x1: 0, y1: -b / 6, x2: a, y2: -b / 6, x: a, y: b / 2},
            {action: "curve", x1: a, y1: b + b / 6, x2: 0, y2: b + b / 6, x: 0, y: b / 2},
            {action: "close"}
        ]},
        {fillStyle: {type: "none"}, lineStyle: {lineWidth: 1}, actions: [
...
Schema.addShape({name: "uiColumnChart", title: "柱状图", category: "ui", attribute: {linkable: false}, props: {w: 250, h: 175}, lineStyle: {lineWidth: 2, lineColor: "136,136,136"}, anchors: [], fontStyle: {size: 14}, textBlock: [
    ...
    {fillStyle: {color: "r-40,g-40,b-40"}, actions: [
...
Schema.addShape({name: "uiBarChart", title: "条形图", category: "ui", attribute: {linkable: false}, props: {w: 250, h: 175}, lineStyle: {lineWidth: 2, lineColor: "136,136,136"}, anchors: [], fontStyle: {size: 14}, textBlock: [
