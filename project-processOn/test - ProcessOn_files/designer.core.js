...
var Designer = {defaults: {linkerBeginArrowStyle: null, linkerEndArrowStyle: null}, config: {panelItemWidth: 30, panelItemHeight: 30, pageMargin: 1000, anchorSize: 8, rotaterSize: 9, anchorColor: "#833", selectorColor: "#833", scale: 1}, status: "", initialize: {initialized: false, initLayout: function () {
    ...
    Model.persistence = {page: Utils.copy(Schema.pageDefaults), elements: {}}
}, initCanvas: function () {
    ...
    $("#designer_canvas").css({"background-color": "rgb(" + j + ")"});
    var e = $("#designer_grids");
    if (e.length > 0) {
        e.attr({width: l, height: f});
    ...
    function e(l, o) {
        ...
        i.bind("mouseenter", function () {
            ...
            var r = {x: 0, y: 0, w: l.props.w, h: l.props.h, angle: l.props.angle};
            var t = 160;
            var s = 160;
            p.clearRect(0, 0, t, s);
            ...
            q.children("canvas").attr({width: t + 20, height: r.h + 20});
            q.show();
            l.props = r;
            p.save();
            p.lineJoin = "round";
    ...
    function c() {
        $(".panel_box").die().live("mousedown", function (s) {
            ...
            $("#canvas_container").bind("mousemove.create", function (A) {
                ...
                q.css({left: v.x - q.width() / 2 + "px", top: v.y - q.height() / 2 + "px", "z-index": Model.orderList.length});
                ...
                q.css({left: (l.props.x - 10).toScale() + "px", top: (l.props.y - 10).toScale() + "px", "z-index": Model.orderList.length});
                        ...
                        for (var z = 0; z < r.length; z++) {
                            ...
                            if (u.type == "line") {
                                ...
                                if (u.anchors.length == 1) {
                                    ...
                                    A.to = {id: l.id, x: y.x, y: y.y, angle: v};
                                    E.from = {id: l.id, x: y.x, y: y.y, angle: v}
                                } else {
                                    if (u.anchors.length == 2) {
                                        ...
                                        A.to = {id: l.id, x: F.x, y: F.y, angle: v};
                                        v = Utils.getPointAngle(l.id, G.x, G.y, C);
                                        E.from = {id: l.id, x: G.x, y: G.y, angle: v}
                                    }
                                }
                                if (u.anchors.length <= 2) {
                                ...
                                var v = Utils.getPointAngle(l.id, y.x, y.y, C);
                                if (u.type == "from") {
                                    A.from = {id: l.id, x: y.x, y: y.y, angle: v}
                                } else {
                                    A.to = {id: l.id, x: y.x, y: y.y, angle: v}
                                }
                                Designer.painter.renderLinker(A, true);
    ...
    function a(m) {
        ...
        i.css({left: "0px", top: "0px", width: $(".panel_container").width(), height: $("#shape_panel").outerHeight()});
                    ...
                    $.getJSON("https://api.iconfinder.com/v2/icons/search?query=" + n + "&offset=" + o + "&count=24&minimum_size=64&vector=false&premium=false", function (w) {
                        ...
                        for (var x = 0; x < D.length; x++) {
                            ...
                            for (var v = 0; v < F.length; v++) {
                                ...
                                var C = Utils.copy(s);
                                C.props = {w: E.size_width, h: E.size_height};
                                C.fillStyle = {type: "image", fileId: t, display: "fill", imageW: E.size_width, imageH: E.size_height};
                                                                                            ...
                                                                                            if (j.keyCode == 76 && !(j.ctrlKey || j.metaKey)) {
                                                                                                ...
                                                                                                if (j.keyCode == 66 && (j.ctrlKey || j.metaKey)) {
                                                                                                    ...
                                                                                                    if (i.length > 0) {
                                                                                                        ...
                                                                                                        Designer.setFontStyle({bold: !c.bold});
                                                                                                        UI.update()
                                                                                                    }
                                                                                                    j.preventDefault()
                                                                                                } else {
                                                                                                    if (j.keyCode == 73 && (j.ctrlKey || j.metaKey)) {
                                                                                                        ...
                                                                                                        if (i.length > 0) {
                                                                                                            var h = Model.getShapeById(i[0]);
                                                                                                            var c = Utils.getShapeFontStyle(h.fontStyle);
                                                                                                            Designer.setFontStyle({italic: !h.fontStyle.italic});
                                                                                                            UI.update()
                                                                                                        }
                                                                                                        j.preventDefault()
                                                                                                    } else {
                                                                                                        if (j.keyCode == 85 && (j.ctrlKey || j.metaKey)) {
                                                                                                            ...
                                                                                                            if (i.length > 0) {
                                                                                                                var h = Model.getShapeById(i[0]);
                                                                                                                var c = Utils.getShapeFontStyle(h.fontStyle);
                                                                                                                Designer.setFontStyle({underline: !c.underline});
                                                                                                                UI.update()
                                                                                                            }
                                                                                                            j.preventDefault()
                                                                                                        } else {
    ...
    this.hide()
}, menuPos: {x: 0, y: 0, shape: null}, show: function (i, h) {
    this.menuPos.x = i;
    this.menuPos.y = h;
    ...
    Utils.hideAnchors();
    $("#link_spot").hide()
}, state: null, changeState: function (a) {
    this.state = a;
    ...
    function v(i, C) {
        if (i.id == null) {
            ...
            if (Utils.isSelected(i.id)) {
                ...
                var B = {x: A.props.x + A.props.w / 2, y: A.props.y + A.props.h / 2};
                var p = Utils.getRotated(B, i, -A.props.angle);
                return{type: "shape", x: (p.x - A.props.x) / A.props.w, y: (p.y - A.props.y) / A.props.h}
            } else {
                return{type: "fixed"}
            }
        }
    ...
    for (var u = 0; u < r.length; u++) {
        ...
        if (d.name == "linker") {
            ...
            if (d.attachTo && !Utils.isSelected(d.id)) {
                a[d.id] = {type: "attached", x: (d.props.x + d.props.w / 2 - q.x) / q.w, y: (d.props.y + d.props.h / 2 - q.y) / q.h}
            } else {
                a[d.id] = {x: (d.props.x - q.x) / q.w, y: (d.props.y - q.y) / q.h}
            }
            ...
            if (H.name != "linker") {
                ...
                if (G.from.type == "box") {
                    ...
                    if (G.from.type == "shape") {
                        ...
                        var J = {x: p.props.x + p.props.w * G.from.x, y: p.props.y + p.props.h * G.from.y};
                        var F = {x: p.props.x + p.props.w / 2, y: p.props.y + p.props.h / 2};
                ...
                if (G.to.type == "box") {
                    ...
                    if (G.to.type == "shape") {
                        ...
                        var J = {x: p.props.x + p.props.w * G.to.x, y: p.props.y + p.props.h * G.to.y};
                        var F = {x: p.props.x + p.props.w / 2, y: p.props.y + p.props.h / 2};
                        var C = Utils.getRotated(F, J, p.props.angle);
                        H.to.x = C.x;
                        H.to.y = C.y
    ...
    $(".shape_controller").bind("mousedown", function (c) {
        ...
        function v(i, D) {
            if (i.id == null) {
                ...
                if (Utils.isSelected(i.id)) {
                    ...
                    var C = {x: B.props.x + B.props.w / 2, y: B.props.y + B.props.h / 2};
                    var p = Utils.getRotated(C, i, -B.props.angle);
                    return{type: "shape", x: (p.x - B.props.x) / B.props.w, y: (p.y - B.props.y) / B.props.h}
                } else {
                    return{type: "fixed"}
                }
            }
        ...
        for (var u = 0; u < r.length; u++) {
            ...
            if (d.name == "linker") {
                ...
                h.push(d);
                if (d.attachTo && !Utils.isSelected(d.id)) {
                    b[d.id] = {type: "attached", x: (d.props.x + d.props.w / 2 - q.x) / q.w, y: (d.props.y + d.props.h / 2 - q.y) / q.h}
                } else {
                    b[d.id] = {x: (d.props.x - q.x) / q.w, y: (d.props.y - q.y) / q.h, w: d.props.w / q.w, h: d.props.h / q.h}
                }
                var t = Model.getShapeLinkers(d.id);
                if (t && t.length > 0) {
                    for (var k = 0; k < t.length; k++) {
                ...
                if (E.name == "linker") {
                    if (O.from.type == "box") {
                        ...
                        if (O.from.type == "shape") {
                            ...
                            var Q = {x: U.props.x + U.props.w * O.from.x, y: U.props.y + U.props.h * O.from.y};
                            var V = {x: U.props.x + U.props.w / 2, y: U.props.y + U.props.h / 2};
                    ...
                    if (O.to.type == "box") {
                        ...
                        if (O.to.type == "shape") {
                            ...
                            var Q = {x: U.props.x + U.props.w * O.to.x, y: U.props.y + U.props.h * O.to.y};
                            var V = {x: U.props.x + U.props.w / 2, y: U.props.y + U.props.h / 2};
                            var G = Utils.getRotated(V, Q, U.props.angle);
                            E.to.x = G.x;
                            E.to.y = G.y
                    ...
                    if (O.type == "attached") {
                        ...
                        D.w = C.w * O.w;
                        D.h = C.h * O.h;
                        var I = {x: E.props.x - B.x, y: E.props.y - B.y, w: E.props.w - B.w, h: E.props.h - B.h};
                ...
                if (z.indexOf("t") >= 0 || z.indexOf("l") >= 0) {
                    for (var Z = 0; Z < h.length; Z++) {
                        ...
                        if (Y.attribute && Y.attribute.collapsed) {
                            var ab = Utils.getCollapsedShapesById(Y.id);
                            if (ab.length > 0) {
                                var aa = Utils.getOutlinkers(ab);
                                ab = ab.concat(aa);
                                var X = Model.getPersistenceById(Y.id);
                                var i = Y.props.x - X.props.x;
                                var ac = Y.props.y - X.props.y;
                                Designer.op.moveShape(ab, {x: i, y: ac}, true);
                                h = h.concat(ab)
                            }
                        }
                    }
    ...
    b.unbind("mousedown.multiselect").bind("mousedown.multiselect", function (e) {
        ...
        $(document).unbind("mouseup.multiselect").bind("mouseup.multiselect", function (h) {
            if (d != null) {
                var f = {x: d.position().left.restoreScale(), y: d.position().top.restoreScale(), w: d.width().restoreScale(), h: d.height().restoreScale()};
    ...
    if (g) {
        ...
        if (a.props.angle != 0) {
            var r = {x: a.props.x + a.props.w / 2, y: a.props.y + a.props.h / 2};
    ...
    if (b.orientation == "horizontal") {
        var j = {x: o.x + o.w / 2, y: o.y + o.h / 2};
        o = {x: j.x - o.h / 2, y: j.y - o.w / 2, w: o.h, h: o.w}
    }
    var p = {width: o.w + "px", "z-index": Model.orderList.length + 2, "line-height": Math.round(b.size * 1.25) + "px", "font-size": b.size + "px", "font-family": b.fontFamily, "font-weight": b.bold ? "bold" : "normal", "font-style": b.italic ? "italic" : "normal", "text-align": b.textAlign, color: "rgb(" + b.color + ")", "text-decoration": b.underline ? "underline" : "none"};
    m.css(p);
    l.css(p);
    m.show();
    o.x += a.props.x;
    ...
    $("#shape_text_edit").unbind().bind("keyup", function () {
        ...
        var C = y + D;
        var A = {x: o.x + o.w / 2, y: w + C / 2};
        var z = a.props.angle;
        if (z != 0) {
            var i = {x: a.props.x + a.props.w / 2, y: a.props.y + a.props.h / 2};
        ...
        m.css({width: o.w, height: D, "padding-top": y, left: A.x.toScale() - o.w / 2 - 2, top: A.y.toScale() - C / 2 - 2, "-webkit-transform": x, "-ms-transform": x, "-o-transform": x, "-moz-transform": x, transform: x})
            ...
            if (v.keyCode == 27) {
                ...
                if (v.keyCode == 66 && v.ctrlKey) {
                    ...
                    if (a.textBlock.length == 1) {
                        ...
                        s.fontStyle = $.extend(s.fontStyle, {bold: t})
                    }
                    b.bold = t;
                    Model.update(a);
                    var u = t ? "bold" : "normal";
                    ...
                    if (v.keyCode == 73 && v.ctrlKey) {
                        ...
                        if (a.textBlock.length == 1) {
                            ...
                            s.fontStyle = $.extend(s.fontStyle, {italic: t})
                        }
                        b.italic = t;
                        Model.update(a);
                        ...
                        if (v.keyCode == 85 && v.ctrlKey) {
                            ...
                            if (a.textBlock.length == 1) {
                                ...
                                s.fontStyle = $.extend(s.fontStyle, {underline: t})
                            }
                            b.underline = t;
                            Model.update(a);
    ...
    b.unbind("mousedown.link").bind("mousedown.link", function (h) {
        ...
        if (!c) {
            ...
            j = {x: i.x.restoreScale(), y: i.y.restoreScale(), id: null, angle: null}
        } else {
            j = a;
            j.id = c.id
        }
    ...
    function e(j, i) {
        ...
        h.from = j;
        h.to = {id: null, x: i.x, y: i.y, angle: null};
        h.props = {zindex: Model.maxZIndex + 1};
        delete h.fontStyle;
        var f = {};
    ...
    b.css({"z-index": Model.orderList.length, "line-height": a + "px", "font-size": g.size + "px", "font-family": g.fontFamily, "font-weight": g.bold ? "bold" : "normal", "font-style": g.italic ? "italic" : "normal", "text-align": g.textAlign, color: "rgb(" + g.color + ")", "text-decoration": g.underline ? "underline" : "none", "-webkit-transform": f, "-ms-transform": f, "-o-transform": f, "-moz-transform": f, transform: f});
    ...
    b.unbind().bind("keyup", function () {
        ...
        b.css({left: d.x.toScale() - i / 2 - 2, top: d.y.toScale() - j / 2 - 2, width: i, height: j})
    }).bind("mousedown", function (i) {
        i.stopPropagation()
    ...
    b.attr("href", a);
    b.show().css({left: c.x - 50, top: c.y - 50, "z-index": Model.orderList.length + 3})
    ...
    a.unbind("mousedown.create_text").bind("mousedown.create_text", function (f) {
        ...
        a.bind("mousemove.create_text", function (g) {
            ...
            e = {"z-index": Model.orderList.length, left: h.x - 1, top: h.y - 1};
            if (h.x > c.x) {
                e.left = c.x - 1
            }
            if (h.y > c.y) {
...
}, canvasDragTimeout: null, canvasDraggable: function () {
    var a = $("#canvas_container");
    ...
    for (var t = 0; t < q.length; t++) {
        ...
        if (b.name == "linker") {
            ...
            if (j && n) {
                ...
                if (v.length > 0) {
                    var f = v.position();
                    v.css({left: f.left += h.x, top: f.top += h.y})
                }
            } else {
                if (j || n) {
            ...
            a(b);
            $(".shape_contour[forshape=" + b.id + "]").css({left: b.props.x.toScale(), top: b.props.y.toScale()})
        }
    }
    ...
    if (m != null) {
        ...
        if (m.type == "bounding") {
            ...
            if (m.type == "shape") {
                ...
                if (q == "from") {
                    ...
                    s = {x: i.from.x, y: i.from.y};
                    d = i.from.id
                }
                if (a.id == d) {
                    Designer.op.hideLinkPoint();
                    b = {x: f.restoreScale(), y: e.restoreScale()};
                    b.angle = null;
                    j = null
                } else {
                    var k = a.getAnchors();
                    var h = -1;
                    var l;
                    var t = {x: a.props.x + a.props.w / 2, y: a.props.y + a.props.h / 2};
                    for (var r = 0; r < k.length; r++) {
                        var o = k[r];
                        var g = Utils.getRotated(t, {x: a.props.x + o.x, y: a.props.y + o.y}, a.props.angle);
        ...
        b = {x: n.x.restoreScale(), y: n.y.restoreScale()};
        b.angle = null;
        j = null
    }
    if (q == "from") {
    ...
    b.fill();
    b.stroke();
    c.css({left: a.x - 16, top: a.y - 16, "z-index": Model.orderList.length}).show()
    ...
    var d = b.position();
    a.css({top: d.top + b.height() + 5, left: d.left + b.width() / 2 - a.outerWidth() / 2, "z-index": Model.orderList.length}).show()
}, hideTip: function () {
    ...
    if (m.attach != null || m.container != null) {
        ...
        var a = h.lineWidth;
        q.css({width: (y.props.w + a).toScale(), height: (y.props.h + a).toScale(), left: (y.props.x - a / 2).toScale() - 2, top: (y.props.y - a / 2).toScale() - 2, "z-index": $("#" + y.id).css("z-index")}).show()
    }
    if (m.h != null) {
        ...
        A.css({width: e.width() + Designer.config.pageMargin * 2, left: -Designer.config.pageMargin, top: Math.round(m.h.y.toScale()), "z-index": Model.orderList.length + 1}).show()
    }
    if (m.v != null) {
        ...
        o.css({height: e.height() + Designer.config.pageMargin * 2, top: -Designer.config.pageMargin, left: Math.round(m.v.x.toScale()), "z-index": Model.orderList.length + 1}).show()
    }
    return m
    ...
    if (q.h != null) {
        ...
        g.css({width: c.width() + Designer.config.pageMargin * 2, left: -Designer.config.pageMargin, top: Math.round(q.h.toScale()), "z-index": Model.orderList.length + 1}).show()
    }
    if (q.v != null) {
        ...
        a.css({height: c.height() + Designer.config.pageMargin * 2, top: -Designer.config.pageMargin, left: Math.round(q.v.toScale()), "z-index": Model.orderList.length + 1}).show()
    }
    var b = {x: o, y: m};
    if (q.h != null) {
        b.y = q.h
    ...
    if (j.h != null) {
        ...
        t.css({width: d.width() + Designer.config.pageMargin * 2, left: -Designer.config.pageMargin, top: Math.round(j.h.y.toScale()), "z-index": Model.orderList.length + 1}).show()
    }
    if (j.v != null) {
        ...
        k.css({height: d.height() + Designer.config.pageMargin * 2, top: -Designer.config.pageMargin, left: Math.round(j.v.x.toScale()), "z-index": Model.orderList.length + 1}).show()
    }
    return j
    ...
    if ($("#panel_" + a).length != 0) {
        ...
        e.css({left: d.to.x.toScale(), top: d.to.y.toScale(), "z-index": Model.orderList.length}).show();
    ...
    function c(i) {
        ...
        if (typeof d.w != "undefined" || typeof d.h != "undefined" || typeof d.angle != "undefined") {
            ...
            var o = {x: a.props.x + a.props.w / 2, y: a.props.y + a.props.h / 2};
            ...
            var j = {x: a.props.x + k / 2, y: a.props.y + n / 2};
...
}}, events: {push: function (c, a) {
    var b = this.listeners[c];
    if (b) {
        return b(a)
    }
    return null
}, listeners: {}, addEventListener: function (b, a) {
    this.listeners[b] = a
}}, clipboard: {elements: [], presetedIds: {}, presetIds: function () {
    this.presetedIds = {};
    ...
    var a = {fontStyle: {}, lineStyle: {}, fillStyle: null, shapeStyle: null};
...
}, painter: {actions: {move: function (a) {
    this.moveTo(a.x, a.y);
    this.prePoint = a;
    ...
    if (typeof this.webkitLineDash != "undefined" && typeof this.lineDashOffset == "undefined" && this.lineWidth != 0) {
        ...
        while (n < 1) {
            ...
            var k = {x: d.x * Math.pow((1 - n), 3) + e.x1 * n * Math.pow((1 - n), 2) * 3 + e.x2 * Math.pow(n, 2) * (1 - n) * 3 + e.x * Math.pow(n, 3), y: d.y * Math.pow((1 - n), 3) + e.y1 * n * Math.pow((1 - n), 2) * 3 + e.y2 * Math.pow(n, 2) * (1 - n) * 3 + e.y * Math.pow(n, 3)};
            var a = Utils.measureDistance(l, k);
            if (a >= g[f] || n >= 1) {
                if (h) {
                    var m = c + (n - c) / 2;
                    var j = {x: d.x * Math.pow((1 - m), 3) + e.x1 * m * Math.pow((1 - m), 2) * 3 + e.x2 * Math.pow(m, 2) * (1 - m) * 3 + e.x * Math.pow(m, 3), y: d.y * Math.pow((1 - m), 3) + e.y1 * m * Math.pow((1 - m), 2) * 3 + e.y2 * Math.pow(m, 2) * (1 - m) * 3 + e.y * Math.pow(m, 3)};
                    this.lineTo(j.x, j.y);
                    this.lineTo(k.x, k.y)
                } else {
                    this.moveTo(k.x, k.y)
    ...
    if (typeof this.webkitLineDash != "undefined" && typeof this.lineDashOffset == "undefined" && this.lineWidth != 0) {
        ...
        while (n < 1) {
            ...
            var k = {x: d.x * Math.pow((1 - n), 2) + e.x1 * n * (1 - n) * 2 + e.x * Math.pow(n, 2), y: d.y * Math.pow((1 - n), 2) + e.y1 * n * (1 - n) * 2 + e.y * Math.pow(n, 2)};
            var a = Utils.measureDistance(l, k);
            if (a >= g[f] || n >= 1) {
                if (h) {
                    var m = c + (n - c) / 2;
                    var j = {x: d.x * Math.pow((1 - m), 2) + e.x1 * m * (1 - m) * 2 + e.x * Math.pow(m, 2), y: d.y * Math.pow((1 - m), 2) + e.y1 * m * (1 - m) * 2 + e.y * Math.pow(m, 2)};
                    this.lineTo(j.x, j.y);
                    this.lineTo(k.x, k.y)
                } else {
                    this.moveTo(k.x, k.y)
    ...
    var f = {x: 0, y: 0, w: c.props.w, h: c.props.h, angle: c.props.angle};
    ...
    if (k.length == 0) {
        var c = $("#designer_canvas");
        k = $("<div id='" + i.id + "' class='shape_box'><canvas class='shape_canvas'></canvas></div>").appendTo(c)
    }
    ...
    k.find(".shape_canvas").attr({width: b, height: f});
    k.css({left: (e.x - 10).toScale() + "px", top: (e.y - 10).toScale() + "px", width: b, height: f});
    ...
    j.fillStyle = {type: "none"};
    j.lineStyle = {lineWidth: 0};
    var d = [j];
    ...
    for (var n = 0; n < b.length; n++) {
        ...
        if (!s.text || s.text.trim() == "") {
            l.css({height: "0px", width: "0px"}).hide();
            continue
        }
        ...
        var p = {"line-height": Math.round(d.size * 1.25) + "px", "font-size": d.size + "px", "font-family": q, "font-weight": d.bold ? "bold" : "normal", "font-style": d.italic ? "italic" : "normal", "text-align": d.textAlign, color: "rgb(" + d.color + ")", "text-decoration": d.underline ? "underline" : "none", opacity: a.shapeStyle.alpha};
        l.css(p);
        l.show();
        var e = s.position;
        ...
        var g = {x: e.x + e.w / 2, y: m + v / 2};
        var f = a.props.angle;
        if (f != 0) {
            var t = {x: a.props.w / 2, y: a.props.h / 2};
        ...
        var c = e.w;
        var k = v;
        l.css({width: c, height: k, left: (g.x + (a.props.x - u.x) + 10).toScale() - e.w / 2, top: (g.y + (a.props.y - u.y) + 10).toScale() - v / 2, "-webkit-transform": r, "-ms-transform": r, "-o-transform": r, "-moz-transform": r, transform: r})
    }
    ...
    function b(v, q, C) {
        var D = v.horizontal;
        var k = v.vertical;
        var l = $("<canvas id='attr_canvas_" + v.id + "' class='attr_canvas'></canvas>").appendTo($("#" + e.id));
        var z = l[0].getContext("2d");
        var r = "12px ";
        var B = a.fontFamily;
        if (localRuntime) {
            if (Utils.containsChinese(q) && !Utils.containsChinese(B)) {
                B = "宋体"
            }
        }
        r += B;
        z.font = r;
        var p = z.measureText(q).width;
        var A = 20;
        if (C != "") {
            p += 20
        }
        ...
        var E = {x: o, y: n, w: p, h: A};
        var m = Utils.getRotatedBox(E, e.props.angle, d);
        l.attr({width: m.w.toScale(), height: m.h.toScale()});
        z.font = r;
        var u = (m.x + (e.props.x - h.x) + 10).toScale();
        var t = (m.y + (e.props.y - h.y) + 10).toScale();
        l.css({left: u, top: t});
        z.scale(Designer.config.scale, Designer.config.scale);
        z.translate(m.w / 2, m.h / 2);
        z.rotate(e.props.angle);
        z.translate(-m.w / 2, -m.h / 2);
        z.translate((m.w - E.w) / 2, (m.h - E.h) / 2);
        z.globalAlpha = e.shapeStyle.alpha;
        if (v.type == "link") {
            z.fillStyle = "#4183C4"
        } else {
            z.fillStyle = "#333"
        ...
        z.fillText(q, 0, A / 2);
        if (C != "") {
            var i = "/images/data-attr/" + C + ".png";
            if (localRuntime) {
                i = "http://localhost:8080" + i
            }
            var s = $(".shape_img[src='" + i + "']");
            if (s.length == 0) {
                s = $("<img class='shape_img' loaded='false' src='" + i + "'/>").appendTo("#shape_img_container")
            }
            if (s.attr("loaded") == "true") {
                z.drawImage(s[0], E.w - 20, 0, 20, 20)
            } else {
                s.bind("load.drawshape", function () {
    ...
    A.attr({width: (f.w + 20).toScale(), height: (f.h + 20).toScale()});
    C.css({left: (f.x - 10).toScale(), top: (f.y - 10).toScale(), width: (f.w + 20).toScale(), height: (f.h + 20).toScale()});
    ...
    m.save();
    var z = {x: o.x - f.x, y: o.y - f.y};
    var c = {x: a.x - f.x, y: a.y - f.y};
    m.save();
    ...
    if (h.linkerType == "curve") {
        var v = q[0];
        var u = q[1];
        var t = {x1: v.x - f.x, y1: v.y - f.y, x2: u.x - f.x, y2: u.y - f.y, x: c.x, y: c.y};
        this.actions.curve.call(m, t)
    } else {
        for (var r = 0; r < q.length; r++) {
            var D = q[r];
            this.actions.line.call(m, {x: D.x - f.x, y: D.y - f.y})
        }
    ...
    var a = {"line-height": Math.round(e.size * 1.25) + "px", "font-size": e.size + "px", "font-family": f, "font-weight": e.bold ? "bold" : "normal", "font-style": e.italic ? "italic" : "normal", "text-align": e.textAlign, color: "rgb(" + e.color + ")", "text-decoration": e.underline ? "underline" : "none", "-webkit-transform": c, "-ms-transform": c, "-o-transform": c, "-moz-transform": c, transform: c};
    b.css(a);
    ...
    var d = g.position();
    b.css({left: j.x.toScale() - d.left - b.width() / 2, top: j.y.toScale() - d.top - b.height() / 2})
}, getLinkerMidpoint: function (c) {
    var g = {};
    if (c.linkerType == "normal") {
        g = {x: 0.5 * c.from.x + 0.5 * c.to.x, y: 0.5 * c.from.y + 0.5 * c.to.y}
    } else {
        if (c.linkerType == "curve") {
            ...
            var h = c.points[1];
            var f = c.to;
            g = {x: o.x * 0.125 + m.x * 0.375 + h.x * 0.375 + f.x * 0.125, y: o.y * 0.125 + m.y * 0.375 + h.y * 0.375 + f.y * 0.125}
        } else {
            var i = [];
            i.push(c.from);
            i = i.concat(c.points);
    ...
    return g
}, controlStatus: {resizeDir: [], rotatable: true}, drawControls: function (h) {
    ...
    if (g.length == 0) {
        ...
        $(".shape_controller").css({"border-color": Designer.config.anchorColor, width: Designer.config.anchorSize - 2, height: Designer.config.anchorSize - 2})
    }
    ...
    var z = l.w.toScale();
    var h = l.h.toScale();
    k.css({left: l.x.toScale(), top: l.y.toScale(), width: z, height: h, "z-index": Model.orderList.length});
    var j = z + 20;
    var o = h + 20;
    ...
    p.translate(-j / 2, -o / 2);
    p.translate(9.5, 9.5);
    var b = {x: Math.round((g.x - l.x).toScale()), y: Math.round((g.y - l.y).toScale()), w: Math.floor(g.w.toScale() + 1), h: Math.floor(g.h.toScale() + 1)};
...
var Model = {define: {}, persistence: {}, orderList: [], maxZIndex: 0, linkerMap: {map: {}, add: function (b, a) {
    if (!this.map[b]) {
        this.map[b] = []
    }
...
var Utils = {getDomById: function (a) {
        ...
        if (s.name == "linker") {
            ...
            if (this.pointInRect(s.to.x.toScale(), s.to.y.toScale(), D)) {
                ...
                if (this.pointInRect(s.from.x.toScale(), s.from.y.toScale(), D)) {
                    ...
                    var A = v.position();
                    var D = {x: A.left, y: A.top, w: v.width(), h: v.height()};
                    ...
                    N = 7;
                    N = N.toScale();
                    var B = this.pointInLinker({x: M.restoreScale(), y: L.restoreScale()}, s, N);
                    if (B > -1) {
                        var t = {type: "linker", shape: s, pointIndex: B};
                        m.push(t);
                        continue
                    }
                }
...
}, selectIds: [], selectShape: function (h, d) {
    if (typeof h == "string") {
        var m = h;
        h = [];
        h.push(m)
...
}, selectCallback: null, unselect: function () {
...
}, linkerCursorTimer: null, showLinkerCursor: function () {
    this.hideLinkerCursor();
    var l = Utils.getSelectedIds();
    if (l.length == 1) {
    ...
    for (var c = 0; c < f.length; c++) {
        ...
        h.half = d;
        h.dom = g;
        g.css({width: b, height: b, "-webkit-border-radius": d, "-moz-border-radius": d, "-ms-border-radius": d, "-o-border-radius": d, "border-radius": d, "z-index": $("#" + e.id).css("z-index")})
    }
    ...
    function d(i, h) {
        ...
        var m = {x: (0.5 * g.x + 0.5 * n.x).toScale(), y: (0.5 * g.y + 0.5 * n.y).toScale()};
        ...
        var k = "rotate(" + e + "deg)";
        o.css({left: m.x, top: m.y - j / 2, height: j, "z-index": Model.orderList.length, "-webkit-transform": k, "-ms-transform": k, "-o-transform": k, "-moz-transform": k, transform: k});
        l.css({left: n.x.toScale() - 4, top: n.y.toScale() - 4, "z-index": Model.orderList.length});
        l.attr("ty", h);
    ...
    f.css({left: i.props.x.toScale(), top: i.props.y.toScale(), "z-index": Model.orderList.length + 1});
    if (!Utils.isSelected(i.id)) {
        f.addClass("hovered_contour")
    }
    var c = Designer.config.anchorSize - 2;
    var b = {"border-color": Designer.config.anchorColor, "border-radius": Designer.config.anchorSize / 2, width: c, height: c};
    var a = i.getAnchors();
    ...
    function e(l) {
        var m = c();
        m.css({left: l.x.toScale() - f.left - 5, top: l.y.toScale() - f.top - 5})
    }
    ...
    if (t.linkerType == "broken") {
        ...
        if (w.id != null && d.id != null) {
            ...
            if (w.id != null || d.id != null) {
                ...
                if (B >= C / 4 && B < C / 4 * 3) {
                    if (i.y < g.y) {
                        if (m >= D) {
                            ...
                            var z = D / 2;
                            A.push({x: g.x, y: g.y - z});
                            A.push({x: i.x, y: g.y - z})
                        }
                    } else {
                        ...
                        if (m >= D) {
                            if (i.x >= e.x - r && i.x <= e.x + e.w + r) {
                                var q = e.x + e.w / 2;
                                if (i.x < q) {
                                    A.push({x: e.x - r, y: g.y - r});
                                    A.push({x: e.x - r, y: i.y})
                                } else {
                                    A.push({x: e.x + e.w + r, y: g.y - r});
                                    A.push({x: e.x + e.w + r, y: i.y})
                                }
                            } else {
                                if (i.x < e.x) {
                                    A.push({x: i.x + r, y: g.y - r});
                                    A.push({x: i.x + r, y: i.y})
                                } else {
                                    A.push({x: i.x - r, y: g.y - r});
                                    A.push({x: i.x - r, y: i.y})
                                }
                            ...
                            if (i.x >= e.x - r && i.x <= e.x + e.w + r) {
                                ...
                                if (i.x < q) {
                                    A.push({x: e.x - r, y: g.y - r});
                                    A.push({x: e.x - r, y: i.y - r});
                                    A.push({x: i.x, y: i.y - r})
                                } else {
                                    A.push({x: e.x + e.w + r, y: g.y - r});
                                    A.push({x: e.x + e.w + r, y: i.y - r});
                                    A.push({x: i.x, y: i.y - r})
                                }
                            } else {
                    ...
                    if (B >= C / 4 * 3 && B < C / 4 * 5) {
                        if (i.x > g.x) {
                            if (m >= D) {
                                var z = m / 2;
                                A.push({x: g.x + z, y: g.y});
                                A.push({x: g.x + z, y: i.y})
                            } else {
                                A.push({x: i.x, y: g.y})
                            }
                        } else {
                            ...
                            if (m >= D) {
                                if (i.y >= e.y - r && i.y <= e.y + e.h + r) {
                                    var q = e.y + e.h / 2;
                                    if (i.y < q) {
                                        A.push({x: g.x + r, y: e.y - r});
                                        A.push({x: i.x + r, y: e.y - r});
                                        A.push({x: i.x + r, y: i.y})
                                    } else {
                                        A.push({x: g.x + r, y: e.y + e.h + r});
                                        A.push({x: i.x + r, y: e.y + e.h + r});
                                        A.push({x: i.x + r, y: i.y})
                                    }
                                } else {
                                ...
                                if (i.y >= e.y - r && i.y <= e.y + e.h + r) {
                                    ...
                                    if (i.y < q) {
                                        A.push({x: g.x + r, y: e.y - r});
                                        A.push({x: i.x, y: e.y - r})
                                    } else {
                                        A.push({x: g.x + r, y: e.y + e.h + r});
                                        A.push({x: i.x, y: e.y + e.h + r})
                                    }
                                } else {
                                    if (i.y < g.y) {
                                        A.push({x: g.x + r, y: i.y + r});
                                        A.push({x: i.x, y: i.y + r})
                                    } else {
                                        A.push({x: g.x + r, y: i.y - r});
                                        A.push({x: i.x, y: i.y - r})
                ...
                if (m >= D) {
                    var z = (d.x - w.x) / 2;
                    A.push({x: w.x + z, y: w.y});
                    A.push({x: w.x + z, y: d.y})
                } else {
                    var z = (d.y - w.y) / 2;
                    A.push({x: w.x, y: w.y + z});
                    A.push({x: d.x, y: w.y + z})
                }
            }
        }
    } else {
        if (t.linkerType == "curve") {
            ...
            function s(E, F) {
                if (E.id != null) {
                    return{x: E.x - k * Math.cos(E.angle), y: E.y - k * Math.sin(E.angle)}
                } else {
    ...
    if (d.linkerType != "curve") {
        ...
        var a = 0;
        while (a <= 1) {
            var e = {x: (1 - a) * (1 - a) * (1 - a) * d.from.x + 3 * (1 - a) * (1 - a) * a * d.points[0].x + 3 * (1 - a) * a * a * d.points[1].x + a * a * a * d.to.x, y: (1 - a) * (1 - a) * (1 - a) * d.from.y + 3 * (1 - a) * (1 - a) * a * d.points[0].y + 3 * (1 - a) * a * a * d.points[1].y + a * a * a * d.to.y};
            b.push(e);
            a += c
        }
    }
    ...
    var k = c.getAnchors();
    var d = [];
    var r = {x: c.props.x + c.props.w / 2, y: c.props.y + c.props.h / 2};
    for (var p = 0; p < k.length; p++) {
        var m = k[p];
        var n = {x: m.x + c.props.x, y: m.y + c.props.y};
    ...
    for (var o = Model.orderList.length - 1; o >= 0; o--) {
        ...
        for (var p = 0; p < d.length; p++) {
            ...
            if (j.from.id == null && this.pointInRect(j.from.x, j.from.y, b)) {
                q = {linker: j, anchors: [a], type: "from"};
                break
            }
            if (j.to.id == null && this.pointInRect(j.to.x, j.to.y, b)) {
                q = {linker: j, anchors: [a], type: "to"};
                break
            }
        }
        e = 2;
    ...
    if (d.linkerType == "normal") {
        ...
        if (d.linkerType == "broken") {
            ...
            c = {x: (1 - b) * (1 - b) * (1 - b) * d.from.x + 3 * (1 - b) * (1 - b) * b * d.points[0].x + 3 * (1 - b) * b * b * d.points[1].x + b * b * b * d.to.x, y: (1 - b) * (1 - b) * (1 - b) * d.from.y + 3 * (1 - b) * (1 - b) * b * d.points[0].y + 3 * (1 - b) * b * b * d.points[1].y + b * b * b * d.to.y}
        }
    }
...
var GradientHelper = {createLinearGradient: function (f, i, h) {
    var b = f.props;
    var c;
    var e;
    var d;
...
var MessageSource = {batchSize: 0, messages: [], withUndo: true, withMessage: true, withDock: true, undoStack: {stack: [], push: function (b, a) {
    this.stack.push(b);
    ...
    Designer.events.push("undoStackChanged", this.stack.length);
    return a
}}, redoStack: {stack: [], push: function (a) {
    this.stack.push(a);
    ...
    if (this.batchSize == 0 && this.messages.length != 0) {
        ...
        if (chartId != "") {
            var a = {action: "command", messages: this.messages, name: userName};
            CLB.send(a)
        }
        this.messages = []
    }
