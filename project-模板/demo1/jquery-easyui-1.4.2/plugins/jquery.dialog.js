...
var _8=$("<div class=\"dialog-form\"></div>").appendTo(_4);
...
var t=$(_17);
return $.extend({},$.fn.window.parseOptions(_17),$.parser.parseOptions(_17,["toolbar","buttons"]),{toolbar:(t.children(".dialog-toolbar").length?t.children(".dialog-toolbar").removeClass("dialog-toolbar"):undefined),buttons:(t.children(".dialog-form").length?t.children(".dialog-form").removeClass("dialog-form"):undefined)});
};
