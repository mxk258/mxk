...
var _292=$("<div class=\"dialog-form\"></div>").appendTo(win);
...
var t=$(_2a0);
return $.extend({},$.fn.window.parseOptions(_2a0),$.parser.parseOptions(_2a0,["toolbar","buttons"]),{toolbar:(t.children(".dialog-toolbar").length?t.children(".dialog-toolbar").removeClass("dialog-toolbar"):undefined),buttons:(t.children(".dialog-form").length?t.children(".dialog-form").removeClass("dialog-form"):undefined)});
};
...
var _2a2=win.find(".messager-input,.messager-form .l-btn");
...
var tb=$("<div class=\"messager-form\"></div>").appendTo(win);
...
win.window("resize");
win.children("div.messager-form").children("a:first").focus();
return win;
};
...
var icon;
if(dir=="east"){
icon="layout-form-left";
}else{
if(dir=="west"){
icon="layout-form-right";
}else{
if(dir=="north"){
icon="layout-form-down";
}else{
if(dir=="south"){
icon="layout-form-up";
}
...
var btn=$("<a href=\"javascript:void(0)\" class=\"textbox-form\"></a>").prependTo(tb);
btn.addClass("textbox-form-"+opts.buttonAlign).linkbutton({text:opts.buttonText,iconCls:opts.buttonIcon});
}
...
var _4af=tb.find(".textbox-form")._outerWidth();
...
_4c2.push({iconCls:"searchbox-form",handler:function(e){
var t=$(e.data.target);
...
var _9ef=parseInt($(e.target).attr("datebox-form-index"));
...
if(_9f1.children("div.datebox-form").length){
return;
}
var _9f2=$("<div class=\"datebox-form\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_9f1);
var tr=_9f2.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-form-a\" href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_9f0):btn.text).appendTo(td);
