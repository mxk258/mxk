...
tb.find(".textbox-form").remove();
if(_8.buttonText||_8.buttonIcon){
var _9=$("<a href=\"javascript:void(0)\" class=\"textbox-form\"></a>").prependTo(tb);
_9.addClass("textbox-form-"+_8.buttonAlign).linkbutton({text:_8.buttonText,iconCls:_8.buttonIcon});
}
_a(_6,_8.disabled);
_b(_6,_8.readonly);
};
...
return $.data(jq[0],"textbox").textbox.find(".textbox-form");
},destroy:function(jq){
return jq.each(function(){
_c(this);
});
...
var _51=tb.find(".textbox-form")._outerWidth();
